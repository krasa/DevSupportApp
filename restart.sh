...
nohup sh -c 'mvn clean && export MAVEN_OPTS="-agentpath:yourkit/libyjpagent.so=port=8766,delay=10000,sessionname=VOJTITKO -Xmx712m -XX:MaxPermSize=250m -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8764" && mvn spring-boot:run' &
