...
import krasa.build.backend.execution.ssh.JschSSHManager;
...
public class JschSshBuildProcess extends AbstractProcess {
	...
	String connectionIP;
	protected JschSSHManager instance;
	protected List<String> command;

	protected JschSshBuildProcess() {
	}

	public JschSshBuildProcess(ProcessLog stringBufferTail, List<String> command) {
	...
	protected int doWork() throws IOException {
		instance = new JschSSHManager(new SCPInfo(userName, password, connectionIP));
		...
		processLog.receiveUntilLineEquals(channel.getExtInputStream(), "logout");
