...
public class ProfileDropDownPanel extends Panel {
    ...
    private DropDownChoice getPhoneVendorDDC(final Form form) {
        ...
        final DropDownChoice<ProfileDropDownChoiceItem> profilesDDC = new DropDownChoice<ProfileDropDownChoiceItem>("profiles", selected, choiceItems, new ChoiceRenderer<ProfileDropDownChoiceItem>("name", "id"));
        // Add Ajax Behaviour...
    ...
    private List<ProfileDropDownChoiceItem> convert(List<Profile> profiles, Model<ProfileDropDownChoiceItem> selected, Integer current) {
